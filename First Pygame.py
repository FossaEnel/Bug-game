...
class Obstacle(pygame.sprite.Sprite):
	def __init__(self,type):
		...
		if type == 'fly':
			...
			spider_1 = pygame.image.load('graphics/Spider1.png').convert_alpha()
			spider_2 = pygame.image.load('graphics/Spider2.png').convert_alpha()
...
class Player(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.player_index = 0
		self.player_jump = pygame.image.load('Graphics/player/player_stand_1.png').convert_alpha()
...
# Intro screen
player_stand = pygame.image.load('Graphics/player/player_stand_1.png').convert_alpha()
player_stand = pygame.transform.rotozoom(player_stand,0,2)
player_stand_rect = player_stand.get_rect(center = (400,200))

game_name = test_font.render('Bug Game',False,(111,196,169))
